 ...
 *
 * Contributed by @yyzhang806. This initial marketplace release incorporates the new-api
...
export const meta = {
  ...
  usageSchema: {
    clips: {
      type: "number",
      unit: "count",
      description: { en: "Number of generated songs.", zh: "生成的歌曲数量。" },
    },
    action: { enum: ["music"], description: { en: "Incho generation action.", zh: "音潮生成动作。" } },
  },
